...
public class Sorter
{
     ...
     * 
     * @param l
     *            record to be re-added to input buffer
     */
    ...
    /**
     * clears out the input buffer of all re-added records adds them to heap
     */
    ...
    /**
     * inserts record to the output buffer if the output buffer it calls
     * sendOutputBuffer()
     * 
     * @param l
     *            record to add
    ...
    private void minHeapify(int index)
    {
        ...
        {
            heapBuffer.putLong((index * 8),
                            heapBuffer.getLong(parentIndex(index) * 8));
     ...
     *            in heap
     * @param size
     *            number of records pulled each time
     * @param runNum
     *            to keep track of runs
     * @param depth
     *            number calls
    ...
    /**
     * This method will set runs for testing purposes
     * 
     * @param inNum
     *            to set
     * @return run
     ...
     * 
     * @param numRec
     *            total numbewr of records in all runs
     */
        ...
        for (int i = 0; i < numRec; i++)
        {
            if (x1 != -1)
            {
                if (getKey(x1) <= getKey(x2))
                {
                    ...
                    if (x1 == hold2)
                    {
                        // needs to get the next input and put it at the
                        // beginning (0)
    ...
    private void merge3(int numRec)
    {
        ...
        for (int i = 0; i < numRec; i++)
        {
            ...
            else if (x3 != -1)
            {
                ...
                if (x3 == 4096)
                {
                    // needs to get the next input and put it at the beginning
                    // (hold3)
     ...
     * 
     * @param numRec
     *            total number of records in all runs
     */
